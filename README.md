...
![github repo size](https://img.shields.io/github/repo-size/daczarne/udemy_python_plotly_dash)
![github code size](https://img.shields.io/github/languages/code-size/daczarne/udemy_python_plotly_dash)
